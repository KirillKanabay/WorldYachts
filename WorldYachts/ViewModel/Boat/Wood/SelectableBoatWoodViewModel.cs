...
{
    public class SelectableBoatWoodViewModel:BaseViewModel
    {
        #region Поля
        ...
        public SelectableBoatWoodViewModel(Data.Entities.BoatWood boatWood,
        ...
        #region Свойства
        public Data.Entities.BoatWood BoatWood { get; }
        public string Info => BoatWood.ToString();
        ...
        private MessageDialogProperty GetConfirmDeleteDialogProperty()
        {
            return new MessageDialogProperty()
            {
                ...
                Message = "Будет удален следующий тип дерева лодки:\n\n" + Info
            };
        }
        ...
        private void ClosingDeleteDialogEventHandler(object sender, DialogClosingEventArgs eventargs)
        {
            if (Equals((eventargs.Parameter), true))
                _boatWoodModel.DeleteAsync(BoatWood);
        }
